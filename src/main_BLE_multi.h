...
//   // BLEDevice::startAdvertising();
//   pAdvertising->start();
//   Serial.println("Waiting a client connection 2 notify...");
// }
...
//         value++;
//         delay(800); // bluetooth stack will go into congestion, if too many packets are sent, in 6 hours test i was able to go as low as 3ms
//     }
//     // disconnecting
